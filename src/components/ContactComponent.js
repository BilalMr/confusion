                ...
                <div className='col-12 col-md-9'>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type='text' id='lastname' name='lastname' placeholder='Last Name' value={this.state.lastname} 
                                        onChange={this.handleInputChange} onBlur={this.handleBlur('lastname')} valid={errors.lastname === ''}
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type='tel' id='email' name='email' placeholder='Email' value={this.state.email} 
